...
/* 
Your task is to allocate dynamically memory for the field before the game starts
and deallocate memory after the end of the game, see comments in the code. 
*/

...
cat tmp_test_input.txt | ./january > tmp_test_output.txt || exit 1
...
cat tmp_test_input_2.txt | ./january > tmp_test_output.txt || exit 1
...
cat tmp_test_input_3.txt | ./january > tmp_test_output.txt || exit 1
grep 16 tmp_test_output.txt | grep "1[.]1" | grep "8[.]5" || exit 1
grep 3 tmp_test_output.txt 2> /dev/null && exit 1
...
cat tmp_test_input_4.txt | ./january > tmp_test_output.txt || exit 1
grep 14 tmp_test_output.txt | grep "[-]1[.]3" | grep "4[.]8" || exit 1
grep 16 tmp_test_output.txt | grep "1[.]1" | grep "8[.]5" || exit 1
